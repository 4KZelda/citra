...
public final class GameProvider extends ContentProvider
{
	...
	public static final String MIME_TYPE_FOLDER = "vnd.android.cursor.item/vnd.citra.folder";
	public static final String MIME_TYPE_GAME = "vnd.android.cursor.item/vnd.citra.game";
