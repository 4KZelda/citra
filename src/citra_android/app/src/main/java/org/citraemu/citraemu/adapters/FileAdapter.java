package org.citraemu.citraemu.adapters;
...
import org.citraemu.citraemu.model.FileListItem;
import org.citraemu.citraemu.viewholders.FileViewHolder;
	...
	public void onBindViewHolder(FileViewHolder holder, int position)
	{
		...
		switch (file.getType())
		{
			case FileListItem.TYPE_FOLDER:
				holder.imageType.setImageResource(R.drawable.classic_a);
				break;

			case FileListItem.TYPE_GC:
				holder.imageType.setImageResource(R.drawable.lb_ic_actions_right_arrow);
				break;
