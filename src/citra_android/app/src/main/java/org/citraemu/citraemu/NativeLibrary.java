...
public final class NativeLibrary
{
	...
	/**
	 * Gets the embedded banner within the given ROM.
	 * 
	 ...
	 */
	public static native int[] GetIcon(String filename, boolean large);

	/**
	 * Gets the embedded title of the given ROM.
	 * 
	 * @param filename The file path to the ROM.
	 * 
	 * @return the embedded title of the ROM.
	 */
	public static native String GetShortTitle(String filename);
	public static native String GetLongTitle(String filename);

	public static native String GetProgramId(String filename);

	public static native String GetPublisher(String filename);
	public static native String GetFileType(String filename);

	/**
	 * Gets the Citra version string.
	 * 
	 * @return the Citra version string.
	 */
	public static native String GetVersionString();

	/**
	 * Creates the initial folder structure in /sdcard/citra-emu/
	 */
